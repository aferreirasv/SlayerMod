...
namespace SlayerMod.Projectiles   //The directory for your .cs and .png; Example: TutorialMOD/Projectiles
{
    public class TheSpikedProjectile : ModProjectile   //make sure the sprite file is named like the class name (CustomYoyoProjectile)
    {

        public override void SetDefaults()
        {
            projectile.extraUpdates = 0;
            projectile.width = 33;//Set the projectile hitbox width
            projectile.height = 33; //Set the projectile hitbox height            
