...
namespace SlayerMod.Projectiles       //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    public class PyronomiconProj : ModProjectile
    {
        ...
        {
            Lighting.AddLight(projectile.Center, ((255 - projectile.alpha) * 0.50f) / 255f, ((255 - projectile.alpha) * 0.15f) / 255f, ((255 - projectile.alpha) * 0.05f) / 255f);   //this is the light colors
